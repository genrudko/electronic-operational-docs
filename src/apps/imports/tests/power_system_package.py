...
def synthetic_power_system_package(*, filename: str = "synthetic-power-system.zip"):
    ...
    asset_rows = [
        ...
        },
        {
            **base,
            ...
            "parent_raw": "35 кВ",
            "hierarchy_path_raw": f"{facility} / 35 кВ / КТП-1",
        },
        {
            **base,
    ...
    issue_rows = [
        {
            "issue_code": "SYNTHETIC-CONFLICT",
            "severity": "MEDIUM",
            "category": "DUPLICATE",
            "source_sheet": "Синтетический перечень",
            "source_rows": "5",
            "evidence": "Синтетическая конфликтная строка.",
            "import_risk": "Ложный дубль.",
            "recommended_handling": "Оставить в построчном карантине.",
