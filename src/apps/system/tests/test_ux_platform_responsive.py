...
class UxPlatformResponsiveSourceContractTests(SimpleTestCase):
    ...
    def test_v10_personnel_current_route_and_compact_workspace_are_server_owned(self) -> None:
        ...
        self.assertIn("@media (max-width:70rem)", css)
        self.assertIn(".personnel-directory-workspace { grid-template-columns:1fr", css)
        self.assertIn("@media (max-width:61.25rem)", css)
        self.assertIn(".personnel-recent-grid { grid-template-columns:1fr", css)
