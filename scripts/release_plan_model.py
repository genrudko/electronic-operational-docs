"""Shared model and canonical constants for the EOD documentation contract."""
...
SOURCE_REGISTRY_PATH = "docs/evidence/SOURCE_REGISTRY.csv"
COVERAGE_SOURCE_PATH = "docs/product/REFERENCE_OPERATIONAL_DOCUMENTATION_COVERAGE.csv"
...
COMPETITOR_MATRIX_PATH = "docs/evidence/COMPETITOR_CAPABILITY_MATRIX.csv"
LEGAL_MODE_MATRIX_PATH = "docs/evidence/DOCUMENT_LEGAL_MODE_MATRIX.csv"
PERSONNEL_AUTHORITY_MATRIX_PATH = "docs/evidence/PERSONNEL_AUTHORITY_MATRIX.csv"
...
EXPECTED_SCENARIOS = (
    "SCN-01:SHIFT|OPJ|PERSONNEL-AUTHORITY|WORKPLACE-DOCS",
    "SCN-02:OPJ|DEFECT|CROSS-DOC|MASTER-DATA",
    "SCN-03:APPLICATION|SWITCHING-DOCUMENTS|SCHEMES-DOCUMENTS|OPJ",
    "SCN-04:WORK-PERMIT|PERMIT-WORK-JOURNAL|PERSONNEL-AUTHORITY",
    "SCN-05:OPERATIONAL-ORDERS|ORDER-WORK-JOURNAL|CROSS-DOC",
    "SCN-06:CURRENT-OPERATION-WORKS|PERSONNEL-AUTHORITY|DEFECT|OPJ",
    "SCN-07:EQUIPMENT-INSPECTIONS|DEFECT|MASTER-DATA",
    "SCN-08:EQUIPMENT-COMMISSIONING|RZA-TM|BREAKER-INTERRUPTIONS|BATTERY-INSPECTION",
    "SCN-09:SHIFT|GROUNDING|DEFECT|APPLICATION|DASHBOARD-REPORTING",
)
