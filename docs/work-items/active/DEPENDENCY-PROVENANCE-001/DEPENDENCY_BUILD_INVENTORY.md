...
| `INP-0023` | `github-action` | `.github/workflows/dependency-provenance.yml:181` | ci/deployment | `actions/upload-artifact@043fb46d1a93c77aae656e7c1c64a875d1fc6a0a` | yes | commit-sha | immutable | LOW | each validated .github/workflows uses reference |
