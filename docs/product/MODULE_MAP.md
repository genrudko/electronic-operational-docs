...
| 3 | `NORMATIVE-EVIDENCE` | Нормативные режимы и evidence-события | `DEMO-BOUNDED` | `ACCEPTED` | `IMPLEMENTED-ACCEPTED` | `NORMATIVE-EVIDENCE-001` |
...
| 5 | `PERSONNEL-AUTHORITY` | Персонал и оперативные полномочия | `DEMO-BOUNDED` | `READY` | `ABSENT` | `PERSONNEL-AUTHORITY-001` |
