...
Журналы доводятся по одному: сначала минимальный общий контракт, затем один журнал полностью с минимальными реальными связями, автоматизированной и пользовательской приёмкой.
