...
- Phase 0: `COMPLETE`.
- `SAFE-CONTINUATION`: `4/8` accepted; **NOT ACHIEVED**.
- `PILOT-READY` mandatory core: `4/21` accepted; **NOT ACHIEVED**.
...
| 1 | `DEPLOYMENT-PROFILE-001` | `P0` | `DEPLOYMENT` | `IN_PROGRESS` | `PSR-003`, `PSR-022`, `PSR-018` | `DEPENDENCY-PROVENANCE-001` | `DEPLOYMENT_OWNER` | `pr`, `exact_head`, `merge_commit`, `workflow_runs`, `owner_acceptance`, `fail_closed_configuration_test` | `SAFE-CONTINUATION` | `P1-DEPLOYMENT-SEQUENTIAL` | `DEPENDENCY_ORDER_AND_GROUP_LIMIT` | — |
...
- [ ] `DEPLOYMENT-PROFILE-001` — `IN_PROGRESS`.
